...
class Settings(BaseSettings):
    ...
    """
    # General settings
    PROJECT_NAME: str = "HCC Extractor Storage Watcher Service"
    PROJECT_DESCRIPTION: str = "Storage watcher service for monitoring file changes and publishing events"
    VERSION: str = "0.1.0"
